---
title: "Relocating Disk Space from Windows to Linux"
date: "2024-04-08"
categories: []
...
This gave me various issues including occasionally failure to recover from sleep.

Surely, there was already
...
These were useful but an error about `swapfile.sys` occurred when I tried Shrink Volume in Windows' Disk Management.
...
If I remembered correctly, I followed these steps to relocate some disk space from Windows to Ubuntu:
